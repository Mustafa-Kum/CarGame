...
namespace FortuneWheel
{
    ...
    {
        private static SpinWheelController _ins;
        public static SpinWheelController ins
        {
            get
            {
                return _ins;
        ...
        public TextMeshProUGUI rewardTextPopup;
        ...
        {
            TDebug.Log(PiecesOfWheel[rewardIndex].rewardAmount);
            
            EventManager.CurrencySystem.RewardedAd?.Invoke(new RewardedAdData
            {
                rewardAmount = PiecesOfWheel[rewardIndex].rewardAmount
            });
        }
